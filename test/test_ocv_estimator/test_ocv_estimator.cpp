...
private:
  ...
  static constexpr OcvPoint OCV_TABLE[] = {{11.90f, 5.0f},  {12.00f, 15.0f},
                                           {12.20f, 50.0f}, {12.40f, 75.0f},
                                           {12.60f, 95.0f}, {12.72f, 100.0f}};
...
void test_temperature_compensation_invalid(void) {
  ...
  TEST_ASSERT_EQUAL_FLOAT(12.50f,
                          OcvEstimator::compensateTo25C(12.50f, INFINITY));
}
...
void test_extreme_voltage_values(void) {
  ...
  // Voltage way below table minimum (possibly reversed polarity or dead
  // battery)
